...
talent[i] = [4, "Ranged Weapon Specialization", 5, 4, 6]; i++;
...
talent[i] = [6, "Arcane Shielding", 1, 1, 4]; i++;
...
talent[i] = [7, "Burning Soul", 1, 4, 3]; i++;
talent[i] = [7, "Improved Scorch", 3, 1, 4]; i++;
talent[i] = [7, "Molten Shields", 1, 2, 4]; i++;
talent[i] = [7, "Master of Elements", 1, 4, 4]; i++;
talent[i] = [7, "Playing with Fire", 1, 1, 5]; i++;
talent[i] = [7, "Critical Mass", 3, 2, 5]; i++;
talent[i] = [7, "Blast Wave", 1, 3, 5,]; i++;
talent[i] = [7, "Blazing Speed", 1, 1, 6]; i++;
talent[i] = [7, "Fire Power", 5, 3, 6]; i++;
talent[i] = [7, "Pyromaniac", 1, 1, 7]; i++;
talent[i] = [7, "Combustion", 1, 2, 7,]; i++;
talent[i] = [7, "Molten Fury", 2, 3, 7]; i++;
talent[i] = [7, "Fiery Payback", 2, 1, 8]; i++;
talent[i] = [7, "Empowered Fire", 1, 3, 8]; i++;
talent[i] = [7, "Firestarter", 1, 1, 9]; i++;
talent[i] = [7, "Dragon's Breath", 1, 2, 9,]; i++;
talent[i] = [7, "Hot Streak", 1, 3, 9]; i++;
talent[i] = [7, "Burnout", 1, 2, 10]; i++;
...
talent[i] = [8, "Frost Warding", 1, 2, 2]; i++;
talent[i] = [8, "Elemental Precision", 3, 3, 2]; i++;
talent[i] = [8, "Permafrost", 1, 4, 2]; i++;
...
talent[i] = [8, "Winter's Chill", 1, 3, 6]; i++;
talent[i] = [8, "Shattered Barrier", 2, 1, 7,]; i++;
talent[i] = [8, "Ice Barrier", 1, 2, 7,]; i++;
talent[i] = [8, "Arctic Winds", 5, 3, 7]; i++;
talent[i] = [8, "Empowered Frostbolt", 1, 2, 8]; i++;
talent[i] = [8, "Fingers of Frost", 1, 3, 8]; i++;
talent[i] = [8, "Brain Freeze", 1, 1, 9]; i++;
talent[i] = [8, "Summon Water Elemental", 1, 2, 9]; i++;
talent[i] = [8, "Improved Water Elemental", 1, 3, 9,]; i++;
talent[i] = [8, "Chilled to the Bone", 1, 2, 10]; i++;
...
talent[i] = [9, "Infusion of Light", 2, 2, 8,]; i++;
talent[i] = [9, "Holy Guidance", 5, 3, 8]; i++;
talent[i] = [9, "Sacred Cleansing", 3, 1, 9]; i++;
talent[i] = [9, "Divine Illumination", 1, 2, 9]; i++;
talent[i] = [9, "Enlightened Judgements", 2, 3, 9]; i++;
talent[i] = [9, "Judgements of the Pure", 5, 2, 10]; i++;
...
talent[i] = [10, "Improved Hammer of Justice", 3, 2, 4]; i++;
...
talent[i] = [10, "One-Handed Weapon Specialization", 5, 3, 6]; i++;
talent[i] = [10, "Spiritual Attunement", 1, 1, 7,]; i++;
...
talent[i] = [11, "sanctity of battle", 3, 3, 4]; i++;
...
talent[i] = [11, "Sheath of Light", 3, 3, 9]; i++;
...
talent[i] = [13, "Searing Light", 2, 3, 4,]; i++;
...
talent[i] = [14, "Improved Devouring Plague", 5, 3, 6]; i++;
...
talent[i] = [14, "Psychic Horror", 2, 1, 9]; i++;
talent[i] = [14, "Vampiric Touch", 1, 2, 9,]; i++; 
talent[i] = [14, "Pain and Suffering", 1, 3, 9]; i++;
...
talent[i] = [15, "Fleet Footed", 2, 1, 5]; i++;
...
talent[i] = [16, "Lightning Reflexes", 5, 3, 4]; i++;
...
talent[i] = [16, "Throwing Specialization", 1, 1, 8]; i++;
...
talent[i] = [17, "Master of Deception", 3, 2, 1]; i++;
talent[i] = [17, "Opportunity", 2, 3, 1]; i++;
talent[i] = [17, "Sleight of Hand", 1, 1, 2]; i++;
...
talent[i] = [18, "Booming Echos", 2, 1, 8]; i++;
talent[i] = [18, "Elemental Oath", 1, 2, 8,]; i++;
talent[i] = [18, "Lightning Overload", 2, 3, 8]; i++;
talent[i] = [18, "Astral Shift", 1, 1, 9]; i++;
...
//Affliction talents
talent[i] = [21, "Curse of Agony", 2, 1, 1]; i++;
...
talent[i] = [21, "Eradication", 1, 1, 7]; i++;
...
talent[i] = [21, "Death's Embrace", 1, 1, 9]; i++;
...
talent[i] = [22, "Demonic Embrace", 5, 3, 1]; i++;
...
talent[i] = [22, "Molten Core", 2, 3, 6]; i++;
...
talent[i] = [23, "Molten Core", 3, 2, 2]; i++;
...
talent[i] = [25, "Shredding Blows", 5, 3, 6]; i++;
